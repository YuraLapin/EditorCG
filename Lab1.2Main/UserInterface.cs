...
namespace Lab1Main
{
    ...
    public static class UserInterface
    {
        ...
        {
            { "LMB Prompt", new Label(900, 30, "ЛКМ - Выделить объект") },
            { "Ctrl Prompt", new Label(900, 50, "Ctrl + ЛКМ - Выделить несколько объектов") },
            { "D prompt", new Label(900, 70, "D - удалить выделенные объекты") },

            { "Draw button", new Button(790, 130, 100, 80, "Нарисовать", DrawLine) },
            { "draw x1", new TextField(910, 100, 100, 20, "X1", 0.0f) },
            { "draw y1", new TextField(910, 130, 100, 20, "Y1", 0.0f) },
            { "draw z1", new TextField(910, 160, 100, 20, "Z1", 0.0f) },
            { "draw x2", new TextField(1020, 100, 100, 20, "X2", 0.0f) },
            { "draw y2", new TextField(1020, 130, 100, 20, "Y2", 0.0f) },
            { "draw z2", new TextField(1020, 160, 100, 20, "Z2", 0.0f) },

            { "Transition button", new Button(790, 220, 100, 80, "Переместить", Transit) },
            { "trans x", new TextField(910, 190, 100, 20, "X", 0.0f) },
            { "trans y", new TextField(910, 220, 100, 20, "Y", 0.0f) },
            { "trans z", new TextField(910, 250, 100, 20, "Z", 0.0f) },

            { "Rotation button X", new Button(790, 280, 100, 20, "Повернуть X", RotateX) },
            { "Rotation button Y", new Button(790, 310, 100, 20, "Повернуть Y", RotateY) },
            { "Rotation button Z", new Button(790, 340, 100, 20, "Повернуть Z", RotateZ) },
            { "rotate x", new TextField(910, 280, 100, 20, "X", 0.0f) },
            { "rotate y", new TextField(910, 310, 100, 20, "Y", 0.0f) },
            { "rotate z", new TextField(910, 340, 100, 20, "Z", 0.0f) },

            { "Scaling button", new Button(790, 400, 100, 80, "Масштаб", Scale) },
            { "scale x", new TextField(910, 370, 100, 20, "X", 1.0f) },
            { "scale y", new TextField(910, 400, 100, 20, "Y", 1.0f) },
            { "scale z", new TextField(910, 430, 100, 20, "Z", 1.0f) },

            { "X prompt", new Label(900, 460, "X - отразить по X") },
            { "Y prompt", new Label(900, 480, "Y - отразить по Y") },
            { "Z prompt", new Label(900, 500, "Z - отразить по Z") },

            { "finish prompt", new Label(900, 520, "ЛКМ - закончить начатое изменение") },
        ...
        public static void Draw(RenderWindow window)
        {
            ...
            {
                uiElement.Value.Draw(window, WINDOW_WIDTH, WINDOW_HEIGHT, SFML.Graphics.Color.Black, phi, teta, zc);
            }
            ...
            foreach (IDrawable userObject in userObjects)
            {
                ...
                {
                    userObject.Draw(window, WINDOW_WIDTH, WINDOW_HEIGHT, SFML.Graphics.Color.Black, phi, teta, zc);
                }
